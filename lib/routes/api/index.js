...
router.get('/xlg/getGasPrice', (request, response) => {
  call(
    response,
...
router.get('/xlg/isSyncing', (request, response) => {
  call(
    response,
...
router.get('/xlg/getBlockNumber', (request, response) => {
  call(
    response,
...
router.get('/xlg/getBalance/:arg', (request, response) => {
...
router.get('/xlg/getBlock/:arg', (request, response) => {
  const { arg } = request.params
  call(
    response,
...
router.get('/xlg/getBlockTransactionCount/:arg', (request, response) => {
  const { arg } = request.params
  call(
    response,
...
router.get('/xlg/getBlockUncleCount/:arg', (request, response) => {
  const { arg } = request.params
  call(
    response,
